...
const useRowStyles = makeStyles({
  ...
  function createData(name, reclamadas, advogado, vara, processo, price) {
    return {
      name,
      reclamadas,
      advogado,
    ...
    return (
      <React.Fragment>
        <TableRow className={classes.root}>
          ...
          <TableCell>{row.reclamadas}</TableCell>
          <TableCell>{row.advogado}</TableCell>
          <TableCell>{row.vara}</TableCell>
  ...
  Row.propTypes = {
    row: PropTypes.shape({
      reclamadas: PropTypes.string.isRequired,
  ...
  const rows = [
    createData('ACEP', 'BK Consultoria e Serviços Ltda.', 'PRC', '11\u00AA', '0101871-50.2017.5.01.0026', 3.99),
    createData('ACEP', 'BK Consultoria e Serviços Ltda.', 'PRC', '11\u00AA', '0101871-50.2017.5.01.0026', 3.99),
    createData('ACEP', 'BK Consultoria e Serviços Ltda.', 'PRC', '11\u00AA', '0101871-50.2017.5.01.0026', 3.99),
    createData('ACEP', 'BK Consultoria e Serviços Ltda.', 'PRC', '11\u00AA', '0101871-50.2017.5.01.0026', 3.99),
    createData('ACEP', 'BK Consultoria e Serviços Ltda.', 'PRC', '11\u00AA', '0101871-50.2017.5.01.0026', 3.99),
